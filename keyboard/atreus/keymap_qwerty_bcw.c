...
#define LAYER_0 KEYMAP( \
  ...
  KC_ESC, KC_TAB, KC_NO, KC_LSFT, KC_SPC, KC_LCTL,  KC_LGUI, KC_BSPC, KC_FN0, KC_FN3,  CTRL(KC_S),  KC_SCLN)
...
#define LAYER_1 KEYMAP( \
  ...
  KC_FN1,         KC_NO,          KC_LGUI,  KC_LSFT,   KC_SPC, KC_LCTL, KC_LGUI, KC_BSPC,  KC_FN0,   KC_FN1,   KC_NO,    KC_DEL)
