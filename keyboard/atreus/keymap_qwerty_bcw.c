 ...
 * esc  tab no shift space    ctrl     || bkspc  space   fn    L3      SAVE   ;
 */
#define LAYER_0 KEYMAP( \
  KC_Q,   KC_W,   KC_E,    KC_R,    KC_T,                       KC_Y,    KC_U,   KC_I,    KC_O,       KC_P, \
  KC_A,   KC_S,   KC_D,    KC_F,    KC_G,                       KC_H,    KC_J,   KC_K,    KC_L,       KC_ENT, \
  KC_FN5, KC_X,   KC_C,    KC_V,    KC_B,                       KC_N,    KC_M,   KC_COMM, KC_DOT,     KC_FN6, \
  KC_ESC, KC_TAB, KC_BSPC, KC_LSFT, KC_SPC, KC_LCTL,    KC_FN7, KC_SPC, KC_FN0, KC_FN3,  CTRL(KC_S),  KC_SCLN)
...
#define LAYER_1 KEYMAP( \
  ...
  SHIFT(KC_LBRC), SHIFT(KC_RBRC), KC_LBRC,  KC_RBRC,   KC_MINS,                  KC_HOME,  KC_LEFT,  KC_UP,    KC_RIGHT,  KC_END,  \
  SHIFT(KC_9),    SHIFT(KC_0),    KC_SLASH, KC_BSLASH, KC_EQL,                   KC_NO,   KC_PGUP,  KC_DOWN,  KC_PGDN,   KC_GRAVE,  \
  KC_FN1,         KC_NO,          KC_NO,    KC_LSFT,   KC_SPC, KC_LCTL, KC_LALT, KC_BSPC,  KC_FN0,   KC_FN1,   KC_NO,    KC_DEL)
...
#define LAYER_2 KEYMAP( \
  ...
  KC_FN2, KC_TAB,     KC_NO,    KC_LSFT,    KC_SPC, KC_LCTL,  KC_LGUI,   KC_BSPC,  KC_FN2,   KC_NO,   KC_NO, KC_NO)
...
#define LAYER_3 KEYMAP( \
  ...
  KC_NO,       KC_NO,  KC_NO,  KC_LSFT,  KC_NO, KC_LCTL,  KC_LGUI,   CTRL(KC_SLASH),  KC_NO, KC_FN3, CTRL(SHIFT(KC_F10)), KC_SLASH)
...
const uint16_t PROGMEM fn_actions[] = {
  ...
  [6] = ACTION_MODS_TAP_KEY(MOD_RSFT, KC_QUOT),  // Holding ' key is SHIFT
  [7] = ACTION_MODS_TAP_KEY(MOD_LGUI, KC_BSPC)  // tap GUI key is bpsc
};
